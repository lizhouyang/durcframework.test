...
public class StudentAnnotationController extends CrudController<Student, StudentService> {
	...
	// http://localhost/durcframeworkTest/listAnno.do?schName=%E5%BC%A0&schStuNo=NO00000013
	...
	// schGender in (0,1)
	// http://localhost/durcframeworkTest/listAnnoGender.do?schGender=0&schGender=1
